...
class PDFGenerator {
  ...
  async initialize(): Promise<void> {
    ...
    console.log('🎨 [pdf] Initializing Playwright browser...')
  ...
  async cleanup(): Promise<void> {
    if (this.browser) {
      ...
      this.browser = null
      console.log('🎨 [pdf] Browser cleaned up')
    }
  }
  ...
  async generatePDF(options: PDFGenerationOptions): Promise<PDFGenerationResult> {
    ...
    console.log(`🎨 [pdf] Starting PDF generation for scan: ${scanId}`)
    ...
    try {
      ...
      try {
        ...
        console.log(`🎨 [pdf] PDF uploaded to: ${filePath}`)
        ...
        if (urlError) {
          console.error('🎨 [pdf] Signed URL error:', urlError)
